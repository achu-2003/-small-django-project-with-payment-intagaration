...
urlpatterns = [
    ...
    path('propelld/webhook/',views.PropelldWebhookView.as_view(), name='propelld-webhook'),
    path('payment/reject-propelld/<int:payment_id>/', views.admin_reject_propelld, name='admin-reject-propelld'),
]
